...
CloudCode adds desktop chat using your CloudCompute account and inference balance. See [CloudCode development and sign-in](CLOUDCODE.md) for local builds, backend setup, and focused tests.
